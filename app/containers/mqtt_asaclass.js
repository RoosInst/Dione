...
class MQTT extends Component {
  ...
  var appWbTopic = this.props.clientID + '/GURUBROWSER/subscribe/1';
  ...
  client.on('message', function (topic, message) {
    ...
    if (topic.includes("admin/")) {
      ...
      //UNSUBSCRIBE
      //console.log('Unsubscribing to: GURUBROWSER/' + this.props.clientID + '/createSubscriber/1');
      //client.unsubscribe('GURUBROWSER/' + this.props.clientID + '/createSubscriber/1');
    ...
    } else if (topic.includes(this.props.clientID)) {
